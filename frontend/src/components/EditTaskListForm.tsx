...
const EditTaskListForm: React.FC<EditTaskListFormProps> = ({ isOpen, onClose, taskList }) => {
  if(!isOpen){
      return null;
  }
    ...
    const handleSubmit = async (event: React.FormEvent) => {
      ...
      try{
        await updateTaskList(taskList.id, updatedTaskListData);
    ...
    <div 
      ...
      >
        ...
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-2xl font-semibold text-black">Update List</h2>
          {/* Botão de Fechar */}
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-end gap-4 mt-8">
              ...
              cursor-pointer disabled:hover:opacity-50 disabled:cursor-not-allowed">
                {isSubmitting ? 'Saving List...' : 'Update List'}
              </button>
            </div>
          </div>
        </form>
